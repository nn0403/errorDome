...
import { schema as productsSchema } from "./entities/products";
import { schema as informationSchema } from "./entities/information";
...
export const actions = {
    ...
    loadSlider: () => {
        return (dispatch, getState) => {
            const { ids } = getState().home.Slider;
            if (ids.length > 0) {
                return null;
            }
